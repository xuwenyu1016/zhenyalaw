<?php exit;?>0015799224311bbd24efa86d010a865f4a373051f7e1s:5728:"a:2:{s:8:"template";s:5664:"<?php $__Template->display("themes/default/head"); ?>
...
<section class="am-padding-vertical-xl services">
    <div class="am-container">
        ...
        <p class="am-margin-top-0 am-margin-bottom-sm"><a href="/">首页</a><?php foreach ($crumb as $vo) { ?> <span class="am-icon-angle-double-right"></span> <a href="/article/gongsifalvshiwu.html"><?php echo $vo["name"];?></a><?php } ?></p>

        <h3 class="page-title"><?php echo $categoryInfo["name"];?> <span>zhenya law services</span></h3>

        <div class="am-tabs am-margin-top-lg" data-am-tabs="{noSwipe: 1}">
            <ul class="am-nav">
                <li>
            ...
            <div class="tabs-bd">
                ...
                <article class="tab-title-box am-padding-horizontal-lg">
                    <span class="am-text-xl"><?php echo $contentInfo["title"];?></span>
                    <img src="/upload/2018-06-01/59.png" class="am-img-responsive am-margin-top-lg" alt="<?php echo $categoryInfo["name"];?>" />
                </article>

                <article class="am-padding-left-xs tab-context"><?php echo $contentInfo["content"];?></article>
...
<?php $__Template->display("themes/default/footer"); ?>";s:12:"compile_time";i:1548386431;}";